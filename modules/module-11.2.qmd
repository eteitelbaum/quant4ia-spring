...
- Install the `marginaleffects` package if you haven't already (`install.packages("marginaleffects")`) and review the [documentation](https://marginaleffects.com/)
- Install the `broom` package if you haven't already (`install.packages("broom")`) and familiarize yourself with the [documentation](https://broom.tidymodels.org/)
:::
