...
## What proportion of M&Ms are blue?
...
-   What is your best guess (your **estimate**) for the proportion of all M&Ms that are blue?
...
An article featuring this plot on the front page of Spanish national newspaper El País was titled *"Catalan public opinion swings toward 'no' for independence, says survey"*.^[Alberto Cairo. [The truthful art: Data, charts, and maps for communication](http://www.thefunctionalart.com/p/the-truthful-art-book.html). New Riders, 2016.] Is this an accurate statment?
...
Calculate the confidence interval manually. A 95% confidence interval is bounded by the middle 95% of the bootstrap distribution.
...
Now, let's visualize the CI for our bootstrap distribution:
...
- Change the confidence level with the `get_ci()` to .90. What happens to the width of the confidence interval?
- Visualize the new confidence interval
- How would you interpret this CI? 
- Now try changing the confidence level to .975. What happens to the width of the confidence interval and how would you interpret it? 
